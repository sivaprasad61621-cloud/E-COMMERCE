...
export let mockProducts = [
  // --- Electronics (Laptops, Phones, Audio, etc.) ---
  { id: 'm-el-1', name: 'Apple MacBook Air M2 Laptop', description: 'Incredibly thin laptop design, Apple M2 chip, 13.6-inch Liquid Retina display, 8GB Unified Memory, 256GB SSD, silent fanless operation.', category_id: 'cat-1', price: 99900, discount: 15, sku: 'MOCK-LAP-99', stock: 15, status: 'active', images: ['https://images.unsplash.com/photo-1517694712202-14dd9538aa97?q=80&w=600'] },
  { id: 'm-el-lap-2', name: 'ASUS Vivobook 15 Laptop', description: '15.6-inch FHD display laptop, Intel Core i5 12th Gen processor, 16GB RAM, 512GB SSD, Windows 11, backlit keyboard, thin & light notebook.', category_id: 'cat-1', price: 49990, discount: 10, sku: 'MOCK-LAP-49', stock: 18, status: 'active', images: ['https://images.unsplash.com/photo-1496181133206-80ce9b88a853?q=80&w=600'] },
  { id: 'm-el-lap-3', name: 'HP Pavilion 14 Laptop', description: '14-inch FHD IPS Touchscreen laptop, AMD Ryzen 5 7530U, 16GB RAM, 512GB SSD, B&O audio, Windows 11, natural silver chassis.', category_id: 'cat-1', price: 58990, discount: 5, sku: 'MOCK-LAP-58', stock: 12, status: 'active', images: ['https://images.unsplash.com/photo-1531297484001-80022131f5a1?q=80&w=600'] },
  { id: 'm-el-lap-4', name: 'Lenovo IdeaPad Slim 3 Laptop', description: '15.6-inch FHD laptop, Intel Core i3 13th Gen, 8GB RAM, 512GB SSD, Windows 11, Arctic Grey lightweight student laptop.', category_id: 'cat-1', price: 39990, discount: 10, sku: 'MOCK-LAP-39', stock: 25, status: 'active', images: ['https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?q=80&w=600'] },
  { id: 'm-el-lap-5', name: 'Dell Inspiron 15 3530 Laptop', description: '15.6-inch FHD 120Hz display laptop, Intel Core i5 13th Gen, 16GB RAM, 512GB SSD, Carbon Black office and business laptop.', category_id: 'cat-1', price: 54990, discount: 8, sku: 'MOCK-LAP-54', stock: 14, status: 'active', images: ['https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?q=80&w=600'] },
