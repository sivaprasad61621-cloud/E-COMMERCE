...
export let mockProducts = [
  ...
  { id: 'm-el-2', name: 'Apple iPhone 15 Pro', description: 'Aerospace-grade titanium design, A17 Pro chip, customizable Action button, 48MP main camera with advanced portraits, USB-C support.', category_id: 'cat-1', price: 134900, discount: 10, sku: 'EL-MOB-011', stock: 20, status: 'active', images: ['https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?q=80&w=600'] },
  ...
  { id: 'm-el-10', name: 'Samsung T7 Shield Portable SSD 2TB', description: 'Rugged external SSD, USB 3.2 Gen 2, reads up to 1050 MB/s, IP65 water and dust resistant, elastomer drop-resistant casing.', category_id: 'cat-1', price: 16500, discount: 0, sku: 'EL-ACC-091', stock: 30, status: 'active', images: ['https://images.unsplash.com/photo-1587829741301-dc798b83add3?q=80&w=600'] },

  // --- Fashion & Apparel (10 products) ---
  { id: 'm-fa-1', name: 'Patagonia Better Sweater Fleece', description: 'Warm 100% recycled polyester fleece jacket, sweater-knit aesthetic exterior, brushed interior, dyed with low-impact process.', category_id: 'cat-2', price: 12500, discount: 0, sku: 'FA-OUT-001', stock: 12, status: 'active', images: ['https://images.unsplash.com/photo-1611312449412-6cefac5dc3e4?q=80&w=600'] },
  ...
  { id: 'm-fa-9', name: 'Lululemon Align Yoga Pant', description: 'Buttery-soft Nulu fabric yoga leggings, weightless naked sensation, high-rise flat waistband, hidden key pocket.', category_id: 'cat-2', price: 8900, discount: 0, sku: 'FA-ACT-081', stock: 16, status: 'active', images: ['https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=600'] },
  ...
  { id: 'm-hk-2', name: 'Flos Arco Floor Lamp', description: 'Luxury floor lamp, solid white Carrara marble base rectangular block, satin-finish stainless steel adjustable arc arm.', category_id: 'cat-3', price: 149000, discount: 0, sku: 'HK-LMP-011', stock: 5, status: 'active', images: ['https://images.unsplash.com/photo-1675767528117-963ce219b52a?q=80&w=600'] },
  { id: 'm-hk-3', name: 'Hario V60 Ceramic Dripper', description: 'Signature pour-over coffee dripper, spiral rib grooves, large single exit hole, heat-retaining ceramic body.', category_id: 'cat-3', price: 1999, discount: 0, sku: 'HK-COF-021', stock: 25, status: 'active', images: ['https://images.unsplash.com/photo-1544816155-12df9643f363?q=80&w=600'] },
  { id: 'm-hk-4', name: 'Baratza Encore Coffee Grinder', description: 'Conical burr coffee grinder, 40 grind settings, DC motor keeps beans cool, pulse button front, commercial grade.', category_id: 'cat-3', price: 14500, discount: 10, sku: 'HK-ACC-031', stock: 12, status: 'active', images: ['https://images.unsplash.com/photo-1545665225-b23b99e4d45e?q=80&w=600'] },
  ...
  { id: 'm-hk-7', name: 'Fog Linen Work Linen Tablecloth', description: '100% natural Lithuanian flax linen, woven border seams, softens with every wash, natural light tan color.', category_id: 'cat-3', price: 8900, discount: 15, sku: 'HK-TAB-061', stock: 10, status: 'active', images: ['https://images.unsplash.com/photo-1601049541289-9b1b7bbbfe19?q=80&w=600'] },
  { id: 'm-hk-8', name: 'Herman Miller Eames Lounge Chair', description: 'Iconic lounge chair and ottoman, molded plywood shells, premium leather upholstery, die-cast aluminum base.', category_id: 'cat-3', price: 239000, discount: 0, sku: 'HK-FUR-071', stock: 3, status: 'active', images: ['https://images.unsplash.com/photo-1527018601619-a508a2be00cd?q=80&w=600'] },
  { id: 'm-hk-9', name: 'Coyuchi Organic Cotton Throw Pillow', description: 'Organic cotton knit cushion cover, down feather insert included, textured seed stitch pattern.', category_id: 'cat-3', price: 4900, discount: 0, sku: 'HK-DEC-081', stock: 22, status: 'active', images: ['https://images.unsplash.com/photo-1505691938895-1758d7feb511?q=80&w=600'] },
  ...
  { id: 'm-so-9', name: 'Osprey Atmos AG 65 Backpack', description: 'Anti-Gravity suspension trampoline mesh back panel, fit-on-the-fly harness, raincover included.', category_id: 'cat-5', price: 23900, discount: 0, sku: 'SO-HIK-081', stock: 9, status: 'active', images: ['https://images.unsplash.com/photo-1502680390469-be75c86b636f?q=80&w=600'] },
  { id: 'm-so-10', name: 'Garmin Instinct 2 Solar Outdoor Watch', description: 'Rugged GPS watch, solar charging power glass, built-in 3-axis compass, trackback routing.', category_id: 'cat-5', price: 39900, discount: 10, sku: 'SO-GPS-091', stock: 11, status: 'active', images: ['https://images.unsplash.com/photo-1510832198440-a52376950479?q=80&w=600'] },
